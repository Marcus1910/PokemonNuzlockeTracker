...
selectGameString = "Select game"
selectAttemptString = "Select the attempt"
newAttemptString = "New attempt"
newLocationString = "New location"
chooseLocationString = "Choose a location"
...
class MainGame():
    ...
    def __init__(self, fileRetriever, gameName: str, saveFileName = 'new'):
